test_that("doConcrete() hasn't changed for competing risks", 
          code = {
              # competing risk
...
test_that("doConcrete() hasn't changed for uncensored competing risks", 
          code = {
              # competing risk
              expect_snapshot_value(x = {
                  data <- as.data.table(survival::pbc)[, c("time", "status", "trt", "id", "age", "sex")]
...
test_that("doConcrete() hasn't changed for right-censored survival", 
          code = {
              # competing risk
              expect_snapshot_value(x = {
                  data <- as.data.table(survival::pbc)[, c("time", "status", "trt", "id", "age", "sex")]
...
test_that("doConcrete() hasn't changed for uncensored survival", 
          code = {
              # competing risk
              expect_snapshot_value(x = {
                  data <- as.data.table(survival::pbc)[, c("time", "status", "trt", "id", "age", "sex")]
